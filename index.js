...
const adicionarPartcipante = (event) => {
  event.preventDefault() // o formulário não é enviado ao clicar no button
  ...
  participantes = [participante, ...participantes] //...spred => espalhar 
  atualizarLista(participantes)
